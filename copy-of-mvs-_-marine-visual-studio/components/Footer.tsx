        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-16">
            ...
            <div className="mb-12 md:mb-0 max-w-sm">
                <a href="#" className="flex items-center gap-2 mb-6">
                    <div className="w-8 h-8 bg-dark text-white flex items-center justify-center rounded-sm">
            ...
            <div className="grid grid-cols-2 gap-16">
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-gray-500">
                        ...
                        <li><a href="#" className="hover:text-neon transition-colors">Career</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-gray-500">
                        ...
                        <li><a href="#" className="hover:text-neon transition-colors">Licensing</a></li>
                    </ul>
                </div>
            </div>
        </div>
